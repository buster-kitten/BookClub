...
<body>
	<div class="addClubback2">
		<form name="newClub"  method="post" action="addClubProcess.jsp" class="addClubform" enctype="multipart/form-data" onsubmit="return check()">
			<h2>클럽 등록</h2>
			<div class="addClubInfo">
				<label for="description" class="jointit">클럽 소개</label>
				<textarea name="description" id="description" cols="10" rows="10" class="basic_textarea"></textarea>
			</div>
			<div class="addClubInfo">
				...
				try {
					String sql="select interest from bc_member where email=?";
