...
<link rel="stylesheet" href="../css/joinin2.css">
</head>
<body>
	<div class="join2back">
		<form name="interest" value="form" method="post" class="joinin2form" action="joinin2Process.jsp">
			...
			<div class="checks">
			<div>
				<input type="checkbox" id="health" name="interest" value="건강" onchange="hashtag()"><label for="health">건강</label>
				<div class="health">
					<input type="checkbox" id="운동" name="interest" value="운동"><label for="운동">운동</label>
					<input type="checkbox" id="건강정보" name="interest" value="건강정보"><label for="건강정보">건강정보</label>
					<input type="checkbox" id="의학" name="interest" value="의학"><label for="의학">의학</label>
					<input type="checkbox" id="정신건강" name="interest" value="정신건강"><label for="정신건강">정신건강</label>
				</div>
			</div>
			<div>
				<input type="checkbox" id="hobby" name="interest" value="취미"><label for="hobby">취미</label>
				<div class="hobby">
				...
				<input type="checkbox" id="literature" name="interest" value="문학"><label for="literature">문학</label>
				<div class="literature">
					...
					<input type="checkbox" id="genrenovel" name="interest" value="장르소설"><label for="genrenovel">장르소설</label>
					<div class="genrenovel">
				...
				<input type="checkbox" id="business" name="interest" value="경제경영"><label for="business">경제경영</label>
				<div class="business">
				...
				<input type="checkbox" id="art" name="interest" value="예술/대중문화"><label for="art">예술/대중문화</label>
				<div class="art">
				...
				<input type="checkbox" id="history" name="interest" value="역사"><label for="history">역사</label>
				<div class="history">
				...
				<input type="checkbox" id="cartoon" name="interest" value="만화"><label for="cartoon">만화</label>
				<div class="cartoon">
				...
				<input type="checkbox" id="humanities" name="interest" value="인문"><label for="humanities">인문</label>
				...
				<input type="checkbox" id="science" name="interest" value="수학/과학"><label for="science">수학/과학</label>
				<div class="science">
				...
				<input type="checkbox" id="socialscience" name="interest" value="사회과학"><label for="socialscience">사회과학</label>
				<div class="socialscience">
				...
				<input type="checkbox" id="computer" name="interest" value="컴퓨터"><label for="computer">컴퓨터</label>
				<div class="computer">
				...
				<input type="checkbox" id="language" name="interest" value="어학"><label for="language">어학</label>
				<div class="language">
				...
				<input type="checkbox" id="test" name="interest" value="수험"><label for="test">수험</label>
				<div class="test">
